                ...
                {                                       
                    ...
                    if (myTouches[i].position.x < Screen.width / 2)
                    {
                        ...
                        if (leftJoystick.joystickStaysInFixedPosition == false)
                        {
                            ...
                            joystickRectTransform.position = currentPosition; // sets the position of the left joystick to where the screen was touched (limited to the left half of the screen)
